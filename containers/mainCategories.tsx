...
const Categories = () => {
  return (
    <div className="w-full flex flex-col items-center mt-12">
      ...
      >
        <img src="/Asset 7.png" alt="" className="w-40 h-32" />
      ...
      <Link
        ...
        className="flex flex-col items-center gap-3 hover:cursor-pointer"
      >
        <img src="/Asset 8.png" alt="" className="w-40 h-32" />
      ...
      <Link
        ...
        className="flex flex-col items-center gap-3 hover:cursor-pointer"
      >
        <img src="/Asset 9.png" alt="" className="w-40 h-32" />
      ...
      <Link
        ...
        className="flex flex-col items-center gap-3 hover:cursor-pointer"
      >
        <img src="/Asset 6.png" alt="" className="w-40 h-32" />
